...
export class AllArtistsCarouselComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    // this.service.get10New().subscribe(a=>this.artists=a);
    this.artists = this.service.getAllMock() // TODO: change to get10New
    this.updateDots();
  }
